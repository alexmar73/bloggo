...
const mongoDBConnectionString = `mongodb+srv://${process.env.dbUser}:${process.env.dbPass}@cluster0.g3iya.mongodb.net/${process.env.dbName}?retryWrites=true&w=majority`;
